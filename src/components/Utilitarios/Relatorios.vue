...
async function carregarRelatorio() {
    ...
    try {
        ...
        console.error(err);
        alert('Erro ao carregar relatório. Verifique o servidor e tente novamente.');
    }
}
</script>
...
<template>
    ...
    <div v-else class="conteudo">
        ...
        <div v-if="showRelatorio" class="result-section">
            <a :href="relatorioUrl" target="_blank" class="btn-search">Abrir Relatório</a>
            <a :href="relatorioUrl" :download="'relatorio.pdf'" class="btn-search" style="margin-left:1rem">Baixar</a>
        </div>
    </div>
</template>
