        ...
        <div v-if="!editCarteira">
            ...
            <div>
                <ol v-for="cart in carteiras">
                    <li>{{ cart.Nome }}<svg @click="editCarteira = true, $emit('editarCarteira', idCarteira); sendID(cart.CarteiraID)" class="alter_icon" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF">
